...
interface UDSEmbedProps {
  onBack: () => void;
}

const UDSEmbed = ({ onBack }: UDSEmbedProps) => {
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 border-b border-glass-border bg-glass/50">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-lg font-medium text-glass-foreground">
                University of Sherbrooke Health Hub - Live Demo
              </h2>
            </div>
            <div className="flex items-center gap-2">
              <a
                href="https://github.com/shurui7/udshh"
                target="_blank"
          ...
          <div className="flex-1 relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-glass z-10">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Loading UDS Health Hub Website...
                  </p>
                  <p className="text-xs text-muted-foreground max-w-md px-4">
                    Starting the University of Sherbrooke Health Hub development server.
                  </p>
                </div>
              </div>
            )}
            ...
            {hasError && (
              <div className="absolute inset-0 flex items-center justify-center bg-glass z-10">
                <div className="text-center space-y-4 max-w-md px-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    UDS Health Hub website is not running
                  </p>
                  <p className="text-xs text-muted-foreground">
                    To view the live website, please run the UDS server:
                  </p>
                  <div className="bg-muted p-3 rounded-md text-xs font-mono text-left">
                    cd Websites/udshh<br/>
                    npm install<br/>
                    PORT=3003 npm start
                  </div>
                  <p className="text-xs text-muted-foreground">
                    The website should be available at http://localhost:3003
                  </p>
                </div>
              </div>
            )}
            ...
            <iframe
              ...
              title="University of Sherbrooke Health Hub Website"
